...
<html>
    ...
    <body>
            ...
            <div class="container">    
            <div class ="panel panel-default panel-body"><h2 ID="head">Create a Listing </h2>
...
<form data-toggle="validator" class="form-horizontal"  action="<?php echo URL; ?>/apartment_upload/upload/" enctype="multipart/form-data" method="post">
  <div class="form-group has-feedback">
    ...
    <div class="col-sm-11">
      <input type="text" name="title" class="form-control" placeholder="100 Character Limit" pattern=".{0,100}" required>
...
<div class="form-group has-feedback">
      <label class="control-label col-sm-1">Contract End Date</label><br>
      <div class="col-sm-11">
...
<div class="row" style="padding-left:15px;" >
  ...
  <select class="form-control col-sm-3" name="numRoommates">
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
  ...
  <select name="numFloors" class="form-control col-sm-3">
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
  ...
  <select name="numBeds" id="numBeds" class="form-control col-sm-3">
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
  ...
  <select name="numBaths" class="form-control col-sm-3">
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
...
<!--            <div class="help-block with-errors"></div>-->
    ...
    <label class="control-label col-sm-1">Upload Images</label>
