        ...
        <h2>
            <div class="right-box">
                <div class="buttons">
                    ...
                    <!-- REMOVE BUTTON -->
                    <p><a class="remove-button" href="<?php echo URL . 'apartments/remove_listing/' . htmlspecialchars($apartment->id, ENT_QUOTES, 'UTF-8'); ?>" target="apartments/listings">Remove</a> </p>
                    <?php } ?>
                </div>
