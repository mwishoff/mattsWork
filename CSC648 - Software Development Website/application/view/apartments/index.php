...
<!-- <div class="container-fluid">
  <div class = "row content">
    <?php if (strpos($_SERVER['REQUEST_URI'], 'search') !== false) echo "<!-- "; ?><div class="col-md-12"> <center><h3 style="color: white">Welcome to GatorRent. The purpose of this website is to provide SFSU Students an alternative housing search option and a safer environment.</h3></center></div><?php if (strpos($_SERVER['REQUEST_URI'], 'search') !== false) echo " -->"; ?>
  </div> -->

<div class="container-fluid">
  <div class = "row content">
    <?php if (strpos($_SERVER['REQUEST_URI'], 'search') !== false) echo "<!-- "; ?><div class="container"><div class="col-md-12"><center><h1>Welcome to GatorRent.</h1></center></div><br><div class="col-md-12"><center><h3> The purpose of this website is to provide SFSU Students a safer searching environment.</h3></center></div></div><?php if (strpos($_SERVER['REQUEST_URI'], 'search') !== false) echo " -->"; ?>
  </div>
...
<!--  <div class="container" id="searchable-container"> -->
     ...
     <div class="col-sm-12 text-left rentalbox"> 
        <div class="container">
         <?php if (strpos($_SERVER['REQUEST_URI'], 'search') === false) echo "<!-- "; ?><div class="col-md-12" style='margin-top:-60px;font-size:1.5em;'><?php if (sizeof($apartments) ==0) echo "Your search \"".$_POST["keywords"]."\" did not match any rooms. Please enter a valid zip code or city name and try again."; else echo "".sizeof($apartments)." results for \"".$_POST["keywords"]."\"";?></div><?php if (strpos($_SERVER['REQUEST_URI'], 'search') === false) echo " -->"; ?>
    ...
    <?php foreach ($apartments as $apartment) { ?>
               <li class="col-md-3">
                <div class="thumbnail clickable1" style="padding: 0">
                  ...
                  <div class="caption">
                    <h3><?php if (isset($apartment->title)) echo htmlspecialchars($apartment->title, ENT_QUOTES, 'UTF-8'); ?></h3>
