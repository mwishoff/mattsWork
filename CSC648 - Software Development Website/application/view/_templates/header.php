    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-user"></span> <?php      
                if (isset($_SESSION['username'])) {echo $_SESSION['username']." (user_id:".$_SESSION['user_id']." is_student:".$_SESSION['is_student'].")"."<li><a href=\"".URL."users/logout\" >Logout</a></li>";} else {echo "<li style='margin-left:-20px;padding-left:-20px'><a href=\"#\" data-toggle=\"modal\" data-target=\"#myModal\">Login/Register</a></li>";}
             ?></a></li>
