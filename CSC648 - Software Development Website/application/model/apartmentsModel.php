...
class ApartmentsModel
{
    ...
    {
        if(isset($keywords)){
            $sql = "SELECT id, title, description, pictures, address_line_1, address_line_2, city, state, ZIP, nr_bedrooms, nr_bathrooms,nr_roommates,rent  FROM apartments WHERE city LIKE :keywords OR ZIP LIKE :keywords";// description LIKE :keywords OR address_line_1 LIKE :keywords OR title LIKE :keywords 
    ...
    public function getAllApartments()
    {
        ...
        $sql = "SELECT id, title, description, pictures, address_line_1, address_line_2, city, state, ZIP, nr_bedrooms, nr_bathrooms,nr_roommates,rent FROM apartments";
        $query = $this->db->prepare($sql);
        $query->execute();
